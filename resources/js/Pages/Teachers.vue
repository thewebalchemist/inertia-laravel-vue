<template>
    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
        <div class="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
            <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Teachers Database</h2>
            ...
            <div v-for="teacher in teachers.data" :key="teacher.id" class="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
                ...
                <div class="p-5">
                    ...
                    <div>
                        ...
                        <span class="text-gray-500 dark:text-gray-400">Science | Math | English</span>
                    </div>
                    <div>
                        <!-- Hourly Rate here -->
                        <span class="text-green-500 font-bold">${{ teacher.hourly_rate }}/hour</span>
                    </div>
                </div>

                    <p class="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">{{ getShortBio(teacher.bio) }}</p>
