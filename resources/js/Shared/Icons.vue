<template>
    ...
    <img v-else-if="name === 'fire'" src="/images/fire.png" alt="fire" />
    <img v-else-if="name === 'facebook'" src="/images/facebook.png" alt="facebook" />
    <img v-else-if="name === 'instagram'" src="/images/instagram.png" alt="instagram" />
    <img v-else-if="name === 'linkedin'" src="/images/linkedin.png" alt="linkedin" />
    <img v-else-if="name === 'twitter'" src="/images/twitter.png" alt="twitter" />
